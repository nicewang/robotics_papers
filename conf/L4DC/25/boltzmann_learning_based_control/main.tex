...
\begin{figure}[htbp]
  ...
  \caption{Drafts of Mathematical Backbone - 1: Policy with Low-Regret (Def. 1 + Def. 2), highlighting the Boltzmann Distribution.}
...
\begin{figure}[htbp]
  ...
  \caption{Drafts of Mathematical Backbone - 2: Reagarding Theorem 1 - Some Understandings, proof of theorem 1 see \cite{andersonlearning}.}
  \label{fig:formula_derivation}
\end{figure}
