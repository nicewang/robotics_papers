...
\begin{itemize}
  \item This vs. \textbf{Hard-Constrained} Methods
    \begin{itemize} Sensitivity to Disturbances
    \end{itemize}
    \begin{itemize} Handling Unknown Obstacles
    \end{itemize}
    \begin{itemize} Trajectory Updating
    \end{itemize}
    \begin{itemize} Recovery Mechanisms
    \end{itemize}
  \item This vs. \textbf{Soft-Constrained} Methods
\end{itemize}
