...
\author{%
  ...
  Topic: Motion Planning, Safety-Guaranteed Collision-Free Navigation, Recovery Mechanism \\
}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Computational Efficient without Complex DL models
...
\begin{itemize}
  ...
  \item Sim-to-Real Training Data for Training Failure Detector
\end{itemize}
