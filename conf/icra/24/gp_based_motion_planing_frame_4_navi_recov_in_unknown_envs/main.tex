...
\author{
  Summarized by Xiaonan (Nice) Wang (wangxiaonannice@gmail.com) \\
...
\begin{abstract}
This document summarizes the core contributions and methodology of the paper "A GP-based Robust Motion Planning Framework for Agile Autonomous Robot Navigation and Recovery in Unknown Environments, \cite{mohammad2024gp}", focusing on its' main ideas and the core blocks.
\end{abstract}

\section*{Disclaimer} 
This summary is for research and study purposes. It represents a personal interpretation and may contain inaccuracies. Feedback or corrections via email are highly appreciated.}
...
The summarized block-diagram see \cref{fig:gp_motion_planning}\footnote{This block-diagram is programmatically generated via Graphviz for efficiency. While visual aesthetics may be limited, the overall structure remains clear.}.
