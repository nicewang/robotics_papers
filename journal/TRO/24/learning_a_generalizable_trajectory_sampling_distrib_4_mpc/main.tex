...
\begin{itemize}
  \item Normalizing Flow (NF)
  \begin{itemize}
    \item Conditions: Start, Goal, Environment, Cost Params
    \item Sampling Distributiom:
      \begin{itemize}
        \item Robot Dynamics
        \item Obstacle Geometries
      \end{itemize}
  \end{itemize}
  \item FlowMPPI: NF + MPPI
  \item FlowiCEM: NF + iCEM
  \item Improved FlowMPPI \& FlowiCEM: Generalizing to Out-of-Distribution (OOD) Environments
  \begin{itemize}
    \item Improved NF: Generalizable Trajectory Sampling Distribution
  \end{itemize}
\end{itemize}
