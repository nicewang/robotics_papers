...
\author{%
  ...
  % Paper: "Title (year), author" -> fr. BibTex
  Summarization Generated based on Paper "Learning a generalizable trajectory sampling distribution for model predictive control (2024), Power, Thomas and Berenson, Dmitry" \\
